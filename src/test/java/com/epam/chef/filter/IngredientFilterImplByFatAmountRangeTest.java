...
public class IngredientFilterImplByFatAmountRangeTest {
    ...
    @Test
    public void filterByFatAmountRangeTest() throws EmptySaladException, FilterException {
        List<Ingredient> ingredientsWithoutChicken = tropicalChickenSalad.getIngredients();
        ingredientsWithoutChicken.remove(chicken);
        ingredientFilter.filterByFatAmountRange(tropicalChickenSalad, 0, 25);
    ...
    public void filterEmptyIngredientListByFatAmountRangeTest() throws EmptySaladException, FilterException {
        ingredientFilter.filterByFatAmountRange(new Salad(), 0, 50);
    }

    @Test(expectedExceptions = FilterException.class)
    public void filterByFatAmountRangeWithIncorrectBoundsTest() throws EmptySaladException, FilterException {
